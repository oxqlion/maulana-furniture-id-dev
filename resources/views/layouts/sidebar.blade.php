            ...
            <aside x-transition:enter="transition transform duration-300"
                ...
                <nav class="flex-1 overflow-hidden hover:overflow-y-auto">
                    <ul class="p-2 overflow-hidden">
                        <li>
                            <a href="{{ route('buat_produk') }}" class="flex items-center p-2 space-x-2 rounded-md hover:bg-gray-100"
                        ...
                        <li>
                            <a href="{{ route('projects') }}" class="flex items-center p-2 space-x-2 rounded-md hover:bg-gray-100"
                                :class="{ 'justify-center': !isSidebarOpen }">
                                <span>
                                    <svg class="w-6 h-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <span :class="{ 'lg:hidden': !isSidebarOpen }">Projects</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-2 space-x-2 rounded-md hover:bg-gray-100"
                                ...
                                <span :class="{ 'lg:hidden': !isSidebarOpen }">Clients</span>
                            </a>
                        </li>
                        <!-- Sidebar Links... -->
                    </ul>
                ...
                <div class="flex-shrink-0 p-2 border-t max-h-14">
                    <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                        ...
                        <button type="submit"
                            ...
                            <span :class="{ 'lg:hidden': !isSidebarOpen }">Logout
                                {{-- <a href="{{ route('logout') }}"
