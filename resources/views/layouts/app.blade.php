            ...
            <div class="flex items-center justify-between relative">
                ...
                <div class="flex items-center">
                    ...
                    <div id="nav-menu"
                        ...
                        <ul class="navbar-nav ms-auto md:flex">
                                ...
                                @if (Route::has('login'))
                                    <li class="group">
                                        <a href="{{ route('login') }}"
                                            ...
                                            <p class=" {{ Route::currentRouteName() == 'login' ? 'text-[#DDBD7E]' : '' }}">
                                                Login</p>
                                            <div
...
{{-- 
                                @if (Route::has('register'))
                                    <li class="group">
                                        <a href="{{ route('register') }}"
                                            class="relative group text-base text-[#434240] lg:text-white hover:text-opacity-50 lg:hover:text-opacity-100 py-2 mx-8 group flex font-normal">
                                            <p
                                                class=" {{ Route::currentRouteName() == 'register' ? 'text-[#DDBD7E]' : '' }}">
                                                Register</p>
                                            <div
                                                class="absolute md:w-full h-0.5 bg-[#DDBD7E] bottom-1 left-0 transform scale-x-0 origin-left transition-transform group-hover:scale-x-100 duration-300">
                                            </div>
    ...
    <section>
        <div class="bg-[#EDF2F4] h-screen">
            <div class="" id="penutup">
                @yield('content')
            </div>
        </div>
    </section>
