...
<div>
    ...
    <div class="py-6">
      ...
      <div class="max-w-5xl px-4 sm:px-6 lg:px-8 mt-6">
        <div class="flex flex-col md:flex-row -mx-4">
          <div class="md:flex-1 px-4">
            <div x-data="{ image: 1 }" x-cloak>
              <div class="h-64 md:h-80 rounded-lg bg-gray-100 mb-4">
                <div x-show="image === 1" class="h-64 md:h-80 rounded-lg mb-4 flex items-center justify-center border-2 border-slate-600 border-solid">
                    <img src="{{ asset('images/products/19_3.png') }}" alt="" class="h-full w-full object-cover rounded-lg">
                </div>
                ...
                <template x-for="i in 3">
                  <div class="flex-1 px-2">
                    <button x-on:click="image = i" :class="{ 'ring-2 ring-indigo-300 ring-inset': image === i }" class="focus:outline-none w-full rounded-lg h-24 md:h-32 bg-gray-100 flex items-center justify-center">
                      <img :src="'images/products/19_' + i + '.png'" alt="Image" class="h-full w-full object-cover rounded-lg">
                    </button>
                  </div>
                </template>
              </div>
