<footer class="bg-[#434240] text-white px-12 pt-12 pb-2 font-montserrat">
    <div class="md:flex flex-wrap">
        ...
        <div class="md:w-1/5 md:pr-8 mb-12 md:mb-4">
            ...
            <ul class="text-sm">
                <li class="mb-3">
                    <a href="https://shopee.co.id/maulanafurnitureindonesia" target="_blank" class="relative group">
                        Shopee
                        <div
                            class="absolute w-full h-0.5 bg-[#DDBD7E] bottom-(-1) left-0 transform scale-x-0 origin-left transition-transform group-hover:scale-x-100 duration-300">
                        </div>
                ...
                <li class="mb-3">
                    <a href="https://www.tokopedia.com/maulanafurnitureind" target="_blank" class="relative group">
                        Tokopedia
                        <div
                            class="absolute w-full h-0.5 bg-[#DDBD7E] bottom-(-1) left-0 transform scale-x-0 origin-left transition-transform group-hover:scale-x-100 duration-300">
                        </div>
        ...
        <div class="md:w-1/5 mb-12 md:mb-4">
            <div class="flex mb-6 space-x-4">
                <a href="https://instagram.com/maulanafurniture.indo?igshid=NzZlODBkYWE4Ng==" target="_blank" class="border-2 border-[#DDBD7E] border-solid rounded-full p-2 relative hover:bg-[#DDBD7E] transition duration-600">
                ...
                <a href="https://www.facebook.com/profile.php?id=100092690556960&mibextid=LQQJ4d" target="_blank" class="border-2 border-[#DDBD7E] border-solid rounded-full p-2 relative hover:bg-[#DDBD7E] transition duration-600">
                ...
                <a href="https://www.tiktok.com/@maulanafurniture.com?_t=8hH0bjzDJuU&_r=1" target="_blank" class="border-2 border-[#DDBD7E] border-solid rounded-full p-2 relative hover:bg-[#DDBD7E] transition duration-600">
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" fill="#DDBD7E" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"/></svg>
                </a>
            </div>
            <div class="text-sm">
                <p class="mb-2">Email: maulanafurniture@gmail.com</p>
                <p>Nomor Telepon: +62 87815879282</p>
            </div>
